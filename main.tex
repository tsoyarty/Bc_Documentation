...
Figure \ref{fig:6Dconfig-space} shows an example of a 6D configuration.
%---------------------------------------------------------------------------------
%---------------------------------------------------------------------------------
\begin{figure}[!ht]
  \centering 
  \begin{subfigure}[b]{0.49\textwidth}
      \includegraphics[width=\textwidth]{figChap5/3D_exampleNew471it.pdf}
      \caption{Front view.}
      \label{fig:rrtstar3D_maze_front}
  \end{subfigure}  
  \begin{subfigure}[b]{0.49\textwidth}
      \includegraphics[width=\textwidth]{figChap5/3D_exampleNew471it_2.pdf}
      \caption{Left view.}
      \label{fig:rrtstarML3D_maze_left}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{figChap5/3D_exampleNew471it_3.pdf}
    \caption{Right view.}
    \label{fig:rrtstarML3D_maze_right}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{figChap5/3D_exampleNew471it_4.pdf}
    \caption{Top view.}
    \label{fig:rrtstarML3D_maze_top}
\end{subfigure}
  \caption{An example of a 6D configuration space with the found solution path. 
  The green color represents obstacle object (tree). 
  The purple color indicates the cube object representing our robot. 
...
%---------------------------------------------------------------------------------
\\
Due to time complexities, 
there was no testing in the 6D configuration space. 
This is because there would be significantly more computations for collision checking, 
predicting samples, and computing costs based on the shortest path and rotations along the XYZ axes. 
Given the trend in time complexity, 
it can be concluded that in the 6D configuration space, 
the implemented RRT*\_ML method will be much slower than the existing RRT* path planner.
