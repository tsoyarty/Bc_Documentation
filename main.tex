...
\begin{table}[htbp]
  ...
  \begin{tabular}{|p{3cm}|c|}
      ...
      \hline
  \end{tabular}
  \caption{Time spaent to find first solution.}
  % \label{tab:params}
\end{table}
%--------------------------------------------------------------------------------- 
%---------------------------------------------------------------------------------
\begin{table}[htbp]
  ...
  \begin{tabular}{|p{3cm}|c|}
      ...
      \hline
  \end{tabular}
  \caption{Time spaent to find final solution.}
  % \label{tab:params}
\end{table}
%--------------------------------------------------------------------------------- 
\section{3D configuration space}
\section{6D configuration space}
%---------------------------------------------------------------------------------
%---------------------------------------------------------------------------------
\clearpage
\section{Result}
